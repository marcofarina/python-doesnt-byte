...
- il tipo di una variabile è determinato durante l'esecuzione del programma, basandosi sul valore assegnato a quella variabile: Python "guarda" il tipo di quel valore e assegna dinamicamente il tipo alla variabile;
